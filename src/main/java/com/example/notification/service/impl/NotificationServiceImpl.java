...
public class NotificationServiceImpl implements NotificationService {
    ...
    @Override
    public void processNotification(MessageRequest msg) throws IOException, TemplateException {
    ...
    private Notification createNotification(MessageRequest msg,
                                            User user) {
    ...
    private void sendNotifications(Notification notification,
                                   MessageRequest msg) throws IOException, TemplateException {
    ...
    private void sendNotification(MessageRequest msg,
                                  String to,
    ...
    private Map<String, Object> createPublicMessage(MessageRequest msg,
                                                    String to,
                                                    String body) {
