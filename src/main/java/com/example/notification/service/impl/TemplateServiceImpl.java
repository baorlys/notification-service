...
public class TemplateServiceImpl implements TemplateService {
    ...
    @Override
    public Template createTemplate(UUID userId, String name, TemplateType type, String html) {
        User user = userRepository.findById(userId).orElse(null);
        Template template = new Template(UUID.randomUUID(), user, name, type, html);
